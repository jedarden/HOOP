...
- `hoop-daemon/src/lib.rs:2567-2596` - Scheduler integration
...
**Documentation:**
- `docs/operations.md:458-832` - Comprehensive disaster recovery documentation
...
- `hoop-daemon/tests/backup_restore_cycle.rs` — Cycle tests
