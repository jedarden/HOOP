# Skills Plugin Infrastructure — Implementation Verification

**Bead:** hoop-ttb.19.1
**Date:** 2026-05-09
**Plan Section:** §22 Extensibility — Skills
...
The manifest schema is documented with inline comments:
...
Skills discovered from `~/.hoop/skills/<name>/` are automatically exposed as MCP tools with the `skill_` prefix.
...
When files in the skills directory change, the watcher reloads the skill library automatically.
