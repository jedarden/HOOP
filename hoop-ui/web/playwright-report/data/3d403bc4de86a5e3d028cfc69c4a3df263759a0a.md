...
- Name: smoke-tests.spec.ts >> Smoke Tests - Patterns View >> should display pattern list or empty state
- Location: e2e/smoke-tests.spec.ts:317:3
...
Locator: locator('.pattern-list, .patterns-container').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.pattern-list, .patterns-container').first()
...
- generic [ref=e2]:
  ...
  - generic [ref=e26]:
    - generic [ref=e27]: 🎤
    - generic [ref=e28]: ⌘+⇧+D
    - button "Dictation settings" [ref=e29] [cursor=pointer]: ⚙
  - button "Open settings" [ref=e31] [cursor=pointer]:
    - img [ref=e32]
  - dialog "Welcome tour" [ref=e35]:
    - generic [ref=e36]:
      - heading "Welcome to HOOP" [level=2] [ref=e37]
      - button "Close tour" [ref=e38] [cursor=pointer]: ×
    - generic [ref=e39]:
      - paragraph [ref=e40]: HOOP is your AI-powered development companion. Let's take a quick tour.
      - generic [ref=e41]:
        - generic [ref=e42]:
          - heading "Stitches" [level=4] [ref=e43]
          - paragraph [ref=e44]: Conversations and work items — where you collaborate with AI agents to get things done.
        - generic [ref=e45]:
          - heading "Patterns" [level=4] [ref=e46]
          - paragraph [ref=e47]: Reusable workflows that span multiple projects and automate repetitive tasks.
