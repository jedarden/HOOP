...
- Name: smoke-tests.spec.ts >> Smoke Tests - Timeline View >> should load timeline view
- Location: e2e/smoke-tests.spec.ts:374:3
...
Locator: locator('.worker-timeline, .timeline-view')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.worker-timeline, .timeline-view')
...
- generic [ref=e2]:
  ...
  - generic [ref=e7]:
    ...
    - main [ref=e18]:
      - generic [ref=e19]:
        - generic [ref=e20]:
          - heading "Worker Timeline" [level=2] [ref=e21]
          - generic [ref=e22]:
            - button "1h" [ref=e23] [cursor=pointer]
            - button "4h" [ref=e24] [cursor=pointer]
            - button "8h" [ref=e25] [cursor=pointer]
            - button "24h" [ref=e26] [cursor=pointer]
            - button "7d" [ref=e27] [cursor=pointer]
        - generic [ref=e28]: No worker activity in the last 24h
  - generic [ref=e29]:
    - generic [ref=e30]: 🎤
    - button "Dictation settings" [ref=e31] [cursor=pointer]: ⚙
```
