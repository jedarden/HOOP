...
- Name: smoke-tests.spec.ts >> Smoke Tests - Cross-Project Dashboard >> should display dashboard metrics
- Location: e2e/smoke-tests.spec.ts:294:3
...
Locator: locator('.cross-project-dashboard, .dashboard').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.cross-project-dashboard, .dashboard').first()
...
- generic [ref=e2]:
  ...
  - generic [ref=e31]:
    - generic [ref=e32]: 🎤
    - button "Dictation settings" [ref=e33] [cursor=pointer]: ⚙
```
