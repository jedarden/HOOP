    ...
    let fixtures: Vec<(&str, String)> = vec![
        ...
        (
            ...
            serde_json::to_string_pretty(&StitchLink {
                ...
                created_at: Some(ts),
                workspace_from: "/home/coding/project1".to_string(),
                workspace_to: "/home/coding/project2".to_string(),
                schema_version: hoop_schema::version::SCHEMA_VERSION.parse().unwrap(),
            })
            .unwrap(),
        ),
        ...
        (
            ...
            serde_json::to_string_pretty(&CrossWorkspaceBlocker {
                bead_id: "hoop-ttb.1.2.3".to_string(),
                workspace: "/home/coding/project".to_string(),
                title: "Blocking bead".to_string(),
        ...
        (
            "bead_blockers_response",
            serde_json::to_string_pretty(&BeadBlockersResponse {
                bead_id: "hoop-ttb.1".to_string(),
                blockers: vec![BeadBlockersResponseBlockersItem {
                    bead_id: "hoop-ttb.1.2.3".to_string(),
                    workspace: "/home/coding/project".to_string(),
                    title: "Blocking bead".to_string(),
                    status: "Open".to_string(),
